...
VALUES (1, 'Byfleet','REGULAR',1),
       (2, 'Bromley ','REGULAR',2),
       (3, 'Bow ','PREMIUM',3),
       (4, 'Beckenham ','PREMIUM',4),
       (5, 'Battersea ','PREMIUM',5),
       (6, 'Barking ','PREMIUM',6),
       (7, 'Balham','PREMIUM',7),
       (8, 'Croydon ','PREMIUM',8),
       (9, 'Chiswick ','PREMIUM',9),
       (10, 'Camberwell','PREMIUM',10),
       (11, 'Enfield ','PREMIUM',11),
       (12, 'Eltham ','PREMIUM',12),
       (13, 'Edmonton ','PREMIUM',13),
       (14, 'Ealing ','PREMIUM',14),
       (15, 'Dagenham ','PREMIUM',15),
       (16, 'Ilford ','PREMIUM',16),
       (17, 'Hounslow ','PREMIUM',17),
       (18, 'Hanger','PREMIUM',18),
       (19, 'Gypsy Corner','PREMIUM',19),
       (20, 'Fulham','REGULAR',20),
       (21, 'Finchley North','REGULAR',21),
       (22, 'Finchley East ','REGULAR',22),
       (23, 'Sheen','REGULAR',23),
       (24, 'Romford','REGULAR',24),
       (25, 'Richmond ','REGULAR',25),
       (26, 'Orpington ','REGULAR',26),
       (27, 'North Kensington ','REGULAR',27),
       (28, 'Nine Elms','REGULAR',28),
       (29, 'New Malden ','REGULAR',29),
       (30, 'New Cross ','REGULAR',30),
       (31, 'Merton ','REGULAR',31),
       (32, 'Kingston ','REGULAR',32),
       (33, 'Kennington ','REGULAR',33),
       (34, 'West Norwood ','REGULAR',34),
       (35, 'West Molesey ','REGULAR',35),
       (36, 'Watford ','REGULAR',36),
       (37, 'Wapping','REGULAR',37),
       (38, 'Wandsworth ','REGULAR',38),
       (39, 'Twickenham ','REGULAR',39),
       (40, 'Tolworth ','REGULAR',40),
       (41, 'Sutton ','REGULAR',41),
       (42, 'Staples Corner','REGULAR',42);
