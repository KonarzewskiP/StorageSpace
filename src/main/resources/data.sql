...
VALUES (1, 'Byfleet','REGULAR'),
       ...
       (17, 'Hounslow ','PREMIUM'),
       (18, 'Hanger','PREMIUM'),
       (19, 'Gypsy Corner','PREMIUM'),
       (20, 'Fulham','REGULAR'),
       (21, 'Finchley North','REGULAR'),
       (22, 'Finchley East ','REGULAR'),
       (23, 'Sheen','REGULAR'),
       (24, 'Romford','REGULAR'),
       (25, 'Richmond ','REGULAR'),
       (26, 'Orpington ','REGULAR'),
       (27, 'North Kensington ','REGULAR'),
       (28, 'Nine Elms','REGULAR'),
       (29, 'New Malden ','REGULAR'),
       (30, 'New Cross ','REGULAR'),
       (31, 'Merton ','REGULAR'),
       (32, 'Kingston ','REGULAR'),
       (33, 'Kennington ','REGULAR'),
       (34, 'West Norwood ','REGULAR'),
       (35, 'West Molesey ','REGULAR'),
       (36, 'Watford ','REGULAR'),
       (37, 'Wapping','REGULAR'),
       (38, 'Wandsworth ','REGULAR'),
       (39, 'Twickenham ','REGULAR'),
       (40, 'Tolworth ','REGULAR'),
       (41, 'Sutton ','REGULAR'),
       (42, 'Staples Corner','REGULAR');

INSERT INTO address (id, city, street, postcode, warehouse_id)
VALUES (1, 'Surrey', '113-115 Oyster Lane', 'KT14 7JZ', 1),
       (2, 'Kent', '12 Farwig Lane', 'BR1 3RB',2),
       (3,  'London', '400 Wick Lane', 'E3 2JG',3),
       (4,  'Kent', '1 Croydon Road', 'BR3 4AA',4),
       (5,  'London', '55 Lombard Road', 'SW11 3RX',5),
       (6,  'London', 'Hertford Road', 'IG11 8BL',6),
       (7,  'London', '7 Weir Road', 'SW12 0LT',7),
       (8,  'London', '202 - 216 Thornton Road', 'CR0 3EU',8),
       (9,  'Middlesex', '961 Great West Road', 'TW8 9FX',9),
       (10,  'London', '49-65 Southampton Way', 'SE5 7SW',10),
       (11,  'London', '1 Progress Way', 'EN1 1FT',11),
       (12,  'London', '400 Westhorne Avenue', 'SE9 5LT',12),
       (13,  'London', '8 Advent Way', 'N18 3AF',13),
       (14,  'London', '399 Uxbridge Road', 'UB1 3EW',14),
       (15,  'Barking', '25 Alfreds Way', 'IG11 0AG',15),
       (16,  'Essex', '374 Eastern Avenue', 'IG2 6NW',16),
       (17,  'Middlesex', '179 - 191 Staines Road', 'TW3 3LL',17),
       (18,  'London', 'Quill Street', 'W5 1DN',18),
       (19,  'London', '12 Jenner Avenue', 'W3 6EQ',19),
       (20,  'London', '71 Townmead Road', 'SW6 2ST',20),
       (21,  'London', '447 High Road', 'N12 0AF',21),
       (22,  'London', '401 High Road', 'N2 8HS',22),
       (23,  'Surrey', '197 Lower Richmond Road', 'TW9 4LN',23),
       (24,  'Essex', 'Ashton Road', 'RM3 8NF',24),
       (25,  'Surrey', 'Lower Mortlake Road', 'TW9 2JX',25),
       (26,  'Orpington', 'Cray Avenue', 'BR5 3PX',26),
       (27,  'London', '149 Scrubs Lane', 'NW10 6RH',27),
       (28,  'London', '120 - 170 Stewarts Road', 'SW8 4UB',28),
       (29,  'New Malden', 'Beverley Way', 'KT3 4PH',29),
       (30,  'London', '155 Lewisham Way', 'SE14 6QP',30),
       (31,  'London', '61 Morden Road', 'SW19 3BE',31),
       (32,  'Surrey', '163 London Road', 'KT2 6NU',32),
       (33,  'London', '289 Kennington Lane', 'SE11 5QY',33),
       (34,  'London', '107 Knights Hill', 'SE27 0SP',34),
       (35,  'West Molesey', '36 Central Avenue', 'KT8 2QZ',35),
       (36,  'Hertfordshire', '1 Ascot Road', 'WD18 8AL',36),
       (37,  'London', '100 The Highway ', 'E1W 2BX',37),
       (38,  'London', '100 Garratt Lane', 'SW18 4DJ',38),
       (39,  'Middlesex', '1A Rugby Road ', 'TW1 1DG',39),
       (40,  'Surrey', '225 Hook Rise South', 'KT6 7LD',40),
       (41,  'Surrey', '12 Kimpton Park Way', 'SM3 9QS',41),
       (42,  'London', '1000 North Circular Road', 'NW2 7JP',42);
